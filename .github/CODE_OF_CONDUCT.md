...
* Being respectful of differing opinions, viewpoints, and reverse-engineering approaches.
* Giving and gracefully accepting constructive feedback.
* Accepting responsibility and apologizing to those affected by our mistakes, and learning from the experience.
* Focusing on what is best not just for us as individuals, but for the overall community and project stability.
...
This Code of Conduct applies within all community spaces (including GitHub repositories, issue trackers, pull requests, and community chat channels), and also applies when an individual is officially representing the community in public spaces.
