...
int git_transport_local(git_transport **out, git_remote *owner, void *param) {
	GIT_UNUSED(out); GIT_UNUSED(owner); GIT_UNUSED(param);
	git_error_set(GIT_ERROR_NET, "Local transport disabled in offline mode");
	return -1;
}

int git_transport_smart(git_transport **out, git_remote *owner, void *param) {
	GIT_UNUSED(out); GIT_UNUSED(owner); GIT_UNUSED(param);
	git_error_set(GIT_ERROR_NET, "Smart transport disabled in offline mode");
	return -1;
}

int git_smart_subtransport_http(git_smart_subtransport **out, git_transport *owner, void *param) {
	GIT_UNUSED(out); GIT_UNUSED(owner); GIT_UNUSED(param);
	git_error_set(GIT_ERROR_NET, "HTTP transport disabled in offline mode");
	return -1;
}

int git_smart_subtransport_git(git_smart_subtransport **out, git_transport *owner, void *param) {
	GIT_UNUSED(out); GIT_UNUSED(owner); GIT_UNUSED(param);
	git_error_set(GIT_ERROR_NET, "Git transport disabled in offline mode");
	return -1;
}
