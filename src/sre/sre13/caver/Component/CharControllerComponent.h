#ifndef SRE13_CHARCONTROLLERCOMPONENT_H
#define SRE13_CHARCONTROLLERCOMPONENT_H

#include "../../core/hook.h"

/* Ported from the lawncher reference — the hero/monster character controller
 * component (movement state, jump/cast timers, run speeds). Recovered offsets;
 * the skillComponent pointer is what the in-game skill bar reads. */
...
#endif /* SRE13_CHARCONTROLLERCOMPONENT_H */