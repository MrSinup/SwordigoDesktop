local XVec2, XVec2_mt, XVec3, XVec3_mt, XVec4, XVec4_mt, XMat3, XMat3_mt, XMat4, XMat4_mt, XQuat, XQuat_mt, XPlane, XPlane_mt, XRay, XRay_mt, XBoundingSphere, XBoundingSphere_mt, XAABox, XAABox_mt, XTriangle, XTriangle_mt, XCapsule, XCapsule_mt, XOBB, XOBB_mt, XBezier3, XBezier3_mt, XCatmullRom, XCatmullRom_mt, XFrustum, XFrustum_mt, XColor, XColor_mt, XCircle, XCircle_mt, XRect2D, XRect2D_mt, XSegment2D, XSegment2D_mt, XPolygon2D, XPolygon2D_mt, XNoise2D, XNoise3D
...
function XQuat:rotate_vector(v)
    return self * v
end
XQuat.rotate = XQuat.rotate_vector
...
local rbmath = {
    ...
    XBoundingSphere = XBoundingSphere,
    Box = XAABox,
    XAABox = XAABox,
    AABox = XAABox,
    OBB = XOBB,
    ...
    Bezier = XBezier3,
    XBezier3 = XBezier3,
    CatmullRom = XCatmullRom,
    XCatmullRom = XCatmullRom,
    ...
    Rect2D = XRect2D,
    XRect2D = XRect2D,
    Segment2D = XSegment2D,
    XSegment2D = XSegment2D,
    Polygon2D = XPolygon2D,
    XPolygon2D = XPolygon2D,
    ...
    -- Swordigo native Vector3 bridges
    to_native = function(v)
    ...
    from_native = function(v)
        if not v then return nil end
        local vx = (type(v.x) == "function" and v:x()) or v.x or 0
        local vy = (type(v.y) == "function" and v:y()) or v.y or 0
        local vz = (type(v.z) == "function" and v:z()) or v.z or 0
        return XVec3.new(vx, vy, vz)
    end,
}
