...
### Scope of this License (`src/platform/`)
This license applies to the Swordigo-specific platform implementations, including:
- **Swordfare Game Overlay & Launcher Frontend**: In-game HUD overlay, theme managers, save editor UI, mod configurations, and GUI controllers.
